<template>
    <div class="container flex flex-col items-center"><NuxtLink :to="`${0}`" class="create-build-btn border-shine flex justify-center items-center"><p class="text-2xl w-max">Создать новый билд!</p></NuxtLink></div>
