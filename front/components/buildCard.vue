<template>
    <NuxtLink :to="`/build/${url}`" class="card border-shine flex flex-row gap-10 p-5">
...
<script setup>
    const props = defineProps(['league','build_name','build_lvl','build_class','url', 'build_class_name'])
